...
public class Constants {
    ...
    public static final String BASE_UBER_URL_V1 = "https://sandbox-api.uber.com/v1/";
    public static final String BASE_UBER_URL_V1_1 = "https://sandbox-api.uber.com/v1.1/";
    ...
    public static String getUberClientId(Activity activity) {
        return getManifestData(activity, "com.jgzuke.intoxicmateandroid.UBER_CLIENT_ID");
    }

    public static String getUberClientSecret(Activity activity) {
        return getManifestData(activity, "com.jgzuke.intoxicmateandroid.UBER_CLIENT_SECRET");
    }

    public static String getUberRedirectUrl(Activity activity) {
        return getManifestData(activity, "com.jgzuke.intoxicmateandroid.UBER_REDIRECT_URL");
    }
